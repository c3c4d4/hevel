...
commands are issued using mouse chords, meaning by pressing a combination of buttons on the mouse. left click will be reffered to as 1, clicking the scroll wheel as 2, and right click as 3.
